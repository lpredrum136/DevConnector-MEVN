<template>
  <b-container>
    <b-card
      ...
      title-tag="h1"
      sub-title="Let's get some information to make your profile stand out"
      sub-title-tag="h4"
    ...
    >
      ...
      <b-form @submit="onSubmit">
        ...
        <b-button type="submit" variant="primary" class="mr-2">Create Profile</b-button>
...
export default {
  ...
  methods: {
    ...
    onSubmit(event) {
      ...
      this.createProfile({ userData, isEdit: false });
    }
  }
};
</script>
